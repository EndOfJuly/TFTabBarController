...
//        badgeView.frame.size = CGSize(width: badgeViewWH, height: badgeViewWH)
...
extension TFTabBarButtonItem {
    ...
    public func setBadgeNum(badgeNum: Int) {
        ...
        if badgeNum > 9 {
            ...
            badgeView.setBackgroundImage(Util.getResizableImage(imageName: badgeViewImageNameNum), for: .normal)
        } else {
